...
# Usage: progress-bar [duration]
# Description: Displays a visual progress bar in the terminal for a specified duration.
# Parameters:
#   duration - The total duration for which the progress bar should run, in seconds.
progress-bar() {
